...
export function ShiftDataForm({
	...
	const handleSubmit = async (event: React.FormEvent) => {
		...
		try {
			...
			const engineHours = Number((hoursValue + minutesValue / 60).toFixed(2));
		...
		<section className={styles.panel}>
			...
			<form className={styles.form} onSubmit={handleSubmit}>
				...
				<div className={styles.form__grid}>
					...
					<div className={`${styles.form__field} ${styles["form__field--compact"]}`}>
						...
						<div className={styles.form__inlineInputs}>
							<div className={styles.form__inlineField}>
								...
								<input
									...
									onChange={(event) => setEngineHoursHours(event.target.value)}
									required
								/>
							</div>
							<div className={styles.form__inlineField}>
								...
								<input
									...
									onChange={(event) => setEngineHoursMinutes(event.target.value)}
									required
								/>
							</div>
						</div>
				...
				<div className={styles.expenseGrid}>
					{renderExpenseSection("Заправки", fuelings, setFuelings, "fueling")}
